...
export default function Page() {
  return (
    <>
      ...
      {/*
      <div className='mx-auto flex w-full flex-col flex-wrap items-center justify-center p-24 md:flex-row  lg:w-4/5'>
        <a href="demo" class="rounded bg-blue-500 px-4 py-2 font-bold text-white hover:bg-blue-700">Go to Viewer</a>
      </div>*/}
